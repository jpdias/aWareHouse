...
\begin{itemize}
\item DHT Library\cite{dhtada}
\item OneWire Library\cite{pjrc}
\item Dallas Temperature Control Library\cite{dallas}
\end{itemize}
...
\begin{itemize}
\item Flask Library\cite{flask}
\item Schedule Library\cite{schedule}
\item pySerial Libray\cite{pyserial}
\end{itemize}
\item Web Languages: 
\begin{itemize}
\item HTML5
\item JavaScript(ECMAScript 5/6)
\item CSS3
\end{itemize}
\item SQL Language: 
\end{itemize}
